<%@ Page Title="" Language="C#" MasterPageFile="~/SiteChild.master" AutoEventWireup="true" CodeBehind="EventCoordinator.aspx.cs" Inherits="Ignite.Organisations.Events.EventCoordinator" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="NestedContent" runat="server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading" style="background-color: #6AA6D6">
            <h5 style="color: white">Event Coordinator(s) for
                <asp:Label runat="server" ID="lblEventName" /><asp:LinkButton runat="server" ForeColor="white" ID="btnNew" CssClass="pull-right" OnClick="btnNew_OnClick">&#x2B;Add New Event Coordinator</asp:LinkButton></h5>
        </div>
        <div class="panel-body">
            <asp:GridView ID="dgvEventCoordinator" runat="server" DataKeyNames="Id" AutoGenerateColumns="false" CssClass="table table-hover table-striped" HorizontalAlign="Center" GridLines="None" BorderStyle="Solid" OnRowDeleting="dgvEventCoordinators_OnRowDeleting" OnRowEditing="dgvEventCoordinators_OnRowEditing">
                <Columns>
                    ...
                    <asp:BoundField DataField="Description" HeaderText="Email" SortExpression="Description" />
        ...
        <div class="modal-dialog" style="width: 800px">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Add/Edit Event Coordinator</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-8 ">
                                <asp:TextBox runat="server" ID="txtName" CssClass="form-control" ValidationGroup="eventCoordinatorValidation" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Name Required!" Display="Dynamic" ValidationGroup="eventCoordinatorValidation" CssClass="label label-danger" ControlToValidate="txtName"></asp:RequiredFieldValidator>
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-8">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Wrong email format!" ControlToValidate="txtEmail" CssClass="label label-danger" Display="Dynamic" ValidationGroup="eventCoordinatorValidation" ValidationExpression="\w+([-+.’]\w+)*@\w+([-.]
\w+)*\.\w+([-.]\w+)*" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Email required!" Display="Dynamic" ValidationGroup="eventCoordinatorValidation" CssClass="label label-danger" ControlToValidate="txtEmail" />
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-8">
                                <asp:CheckBox runat="server" ID="chkActive" Enabled="False" Checked="True" />
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <asp:LinkButton ID="btnSaveEventCoordinator" CssClass="btn btn-success" ClientIDMode="Static" runat="server" OnClick="btnSaveEventCoordinator_OnClick" ValidationGroup="Validation">Save</asp:LinkButton>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
