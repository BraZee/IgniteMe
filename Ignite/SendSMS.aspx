<%@ Page Title="" Language="C#" MasterPageFile="~/SiteChild.master" AutoEventWireup="true" CodeBehind="SendSMS.aspx.cs" Inherits="Ignite.SendSMS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NestedContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="panel panel-info">
                <div class="panel-heading" style="background-color: #6AA6D6">
                    <h5 style="color: white">Send SMS</h5>
                </div>
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group col-md-12">
                                <div class="col-md-12">
                                    ...
                                    <asp:Label runat="server" ID="smsOverflow" CssClass="label label-danger" Visible="False"/>
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <div class="col-md-2">
