<%@ Page Title="" Language="C#" MasterPageFile="~/SiteChild.master" AutoEventWireup="true" CodeBehind="EventInterests.aspx.cs" Inherits="Ignite.Organisations.Events.EventInterests" %>
<asp:Content ID="Content1" ContentPlaceHolderID="NestedContent" runat="server">
    ...
    <div class="panel panel-info">
        <div class="panel-heading" style="background-color: #6AA6D6">
            <h5 style="color: white">Assign Interests <asp:Label runat="server" ID="userGroup" Text=" "/><asp:LinkButton ForeColor="white" runat="server" ID="btnAdd" Text="+Add" CssClass="btn btn-outline btn-link pull-right" OnClick="btnAdd_OnClick"/><asp:DropDownList runat="server" ID="cbInterests" CssClass="pull-right" ForeColor="black"/></h5>
       
             </div>
        <div class="panel-body">
            <asp:GridView ID="dgvInterests" runat="server" EmptyDataText="Select at least one interest." DataKeyNames="Key" OnRowDeleting="dgvInterests_OnRowDeleting" AutoGenerateColumns="false" CssClass="table table-hover table-striped" HorizontalAlign="Center" GridLines="None" BorderStyle="Solid">
                <Columns>
